...
/*
  Solution by : https://stackoverflow.com/questions/31707747/how-to-make-an-angular-material-table-responsive
*/
export class appTableResponsiveDirective implements OnInit, AfterViewInit, OnDestroy {
